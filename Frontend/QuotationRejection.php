    ...
    <div class="col-md-6   rounded shadow p-2 mx-auto">
        ...
        <div class="container mt-5">
            ...
            <form action="" method="post" class="row g-3">
                ...
                <!--------------------Quotation Rejection Reason input field-------------------->

                <div class="col   ">
                    <label class="form-label">Quotation Rejection Reason</label>
                    ...
                    <!--------------------Rejection Description input field-------------------->

                    <label class="form-label mt-3">Rejection Description</label>
